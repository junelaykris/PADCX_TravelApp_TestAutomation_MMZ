...
import com.padcx.travelapp.travelapp_testautomation_mmz.views.viewholders.PopularTourViewHolder
...
class PopularTourListAdapter(delegate: ToursItemDelegate) : BaseRecyclerAdapter<BaseViewHolder<CountryVO>, CountryVO>() {
    ...
    override fun onCreateViewHolder(
        ...
        val view = LayoutInflater.from(parent.context).inflate(R.layout.tours_list_item, parent,false)
